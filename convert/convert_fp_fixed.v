...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=16 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  convert_fp_fixed_altbarrel_shift_g4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //convert_fp_fixed_altbarrel_shift_g4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  convert_fp_fixed_altfp_convert_s2o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	convert_fp_fixed_altbarrel_shift_g4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		const_bias_value_add_width_res_w = 8'b10001110,
...
endmodule //convert_fp_fixed_altfp_convert_s2o
//VALID FILE
...
module convert_fp_fixed (
	...
	convert_fp_fixed_altfp_convert_s2o	convert_fp_fixed_altfp_convert_s2o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
