...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=22 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=1 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  FIXED_Convert_altbarrel_shift_eof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FIXED_Convert_altbarrel_shift_eof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //FIXED_Convert_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //FIXED_Convert_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	FIXED_Convert_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	FIXED_Convert_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //FIXED_Convert_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	FIXED_Convert_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	FIXED_Convert_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //FIXED_Convert_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	FIXED_Convert_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	FIXED_Convert_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //FIXED_Convert_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	FIXED_Convert_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	FIXED_Convert_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //FIXED_Convert_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	FIXED_Convert_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	FIXED_Convert_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //FIXED_Convert_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	FIXED_Convert_altpriority_encoder_be8   altpriority_encoder16
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	FIXED_Convert_altpriority_encoder_be8   altpriority_encoder17
	( 
	.data(data[15:8]),
...
endmodule //FIXED_Convert_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	FIXED_Convert_altpriority_encoder_r08   altpriority_encoder4
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder4_q));
	FIXED_Convert_altpriority_encoder_rf8   altpriority_encoder5
	( 
	.data(data[31:16]),
...
endmodule //FIXED_Convert_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 180 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FIXED_Convert_altfp_convert_51o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	FIXED_Convert_altbarrel_shift_eof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	FIXED_Convert_altpriority_encoder_qb6   altpriority_encoder2
	( 
	...
	assign
		bias_value_w = 8'b01101010,
		const_bias_value_add_width_int_w = 8'b01111110,
...
endmodule //FIXED_Convert_altfp_convert_51o
//VALID FILE
...
module FIXED_Convert (
	...
	FIXED_Convert_altfp_convert_51o	FIXED_Convert_altfp_convert_51o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
