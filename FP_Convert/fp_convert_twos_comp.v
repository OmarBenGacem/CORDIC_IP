...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=22 aclr clk_en clock dataa result
...
module  fp_convert_twos_comp_altbarrel_shift_f4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_convert_twos_comp_altbarrel_shift_f4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 242 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_twos_comp_altfp_convert_61o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	fp_convert_twos_comp_altbarrel_shift_f4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		const_bias_value_add_width_res_w = 8'b10000000,
...
endmodule //fp_convert_twos_comp_altfp_convert_61o
//VALID FILE
...
module fp_convert_twos_comp (
	...
	fp_convert_twos_comp_altfp_convert_61o	fp_convert_twos_comp_altfp_convert_61o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
